...
def transcribe_audio(audio_bytes: bytes, filename: str = "answer.webm", api_provider: str = "evalynx", api_key: str | None = None) -> str:
...
def synthesize_speech(text: str, api_provider: str = "evalynx", api_key: str | None = None) -> bytes:

    ...
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:mt-10 sm:grid-cols-2">
        ...
        <AgentCard
          ...
          description="Practice realistic interviews with an AI interviewer using dynamic questioning, voice or text answers, and intelligent evaluation."
        ...
        <AgentCard
          ...
          description="Get a personalized learning path based on your career goal, background, current skills, interests, and skill gaps."
          badges={["LLM", "Career Guidance", "Skill Gap Analysis"]}
        />
      </div>
